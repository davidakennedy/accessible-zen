 ...
 * in WordPress 3.4.
 *
 * @uses zh_header_style()
 * @uses zh_admin_header_style()
 * @uses zh_admin_header_image()
 *
 * @package ZH
 */
function zh_custom_header_setup() {
	...
	$args = apply_filters( 'zh_custom_header_args', $args );
...
if ( ! function_exists( 'zh_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see zh_custom_header_setup().
 *
 * @since ZH 1.0
 */
...
endif; // zh_header_style

if ( ! function_exists( 'zh_admin_header_style' ) ) :
/**
...
endif; // zh_admin_header_style

if ( ! function_exists( 'zh_admin_header_image' ) ) :
/**
